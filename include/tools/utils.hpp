...
struct PointXYZIRLICO
{
  PCL_ADD_POINT4D;                    // quad-word XYZ
  float    intensity;                 ///< laser intensity reading
  uint16_t ring;                      ///< the lidar ring
...
POINT_CLOUD_REGISTER_POINT_STRUCT(PointXYZIRLICO,
                                  (float, x, x)
                                  (float, y, y)
                                  (float, z, z)
...
void PointXYZIRLICO2XYZI(pcl::PointCloud<PointXYZIRLICO>& src,
...
int count_num_ground(const pcl::PointCloud<PointXYZIRLICO>& pc){
  int num_ground = 0;
...
std::map<int, int> count_num_each_class(const pcl::PointCloud<PointXYZIRLICO>& pc){
  int num_ground = 0;
...
int count_num_outliers(const pcl::PointCloud<PointXYZIRLICO>& pc){
  int num_outliers = 0;
...
void discern_ground(const pcl::PointCloud<PointXYZIRLICO>& src, pcl::PointCloud<PointXYZIRLICO>& ground, pcl::PointCloud<PointXYZIRLICO>& non_ground){
  ground.clear();
  non_ground.clear();
  std::vector<int>::iterator iter;
...
void calculate_precision_recall(const pcl::PointCloud<PointXYZIRLICO>& pc_curr,
                                pcl::PointCloud<PointXYZIRLICO>& ground_estimated,
                                double & precision,
                                double& recall,
...
int save_all_labels(const pcl::PointCloud<PointXYZIRLICO>& pc, string ABS_DIR, string seq, int count){
...
void save_all_accuracy(const pcl::PointCloud<PointXYZIRLICO>& pc_curr,
                      pcl::PointCloud<PointXYZIRLICO>& ground_estimated, string acc_filename,
...
void pc2pcdfile(const pcl::PointCloud<PointXYZIRLICO>& TP, const pcl::PointCloud<PointXYZIRLICO>& FP,
                const pcl::PointCloud<PointXYZIRLICO>& FN, const pcl::PointCloud<PointXYZIRLICO>& TN,
